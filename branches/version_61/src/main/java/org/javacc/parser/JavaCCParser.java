...
p.lastToken = t;
  ...
  final public void token_manager_decls() throws ParseException {java.util.List decls = new java.util.ArrayList();
          Token t;
...
{if ("" != null) return remove_escapes_and_quotes(t, t.image);}
  ...
  final public void Arguments(java.util.List tokens) throws ParseException {Token first, last;
          if (tokens == null)
            tokens = new ArrayList();
    jj_consume_token(LPAREN);
first = getToken(1);
...
void AnnotationTypeDeclaration(int modifiers) throws ParseException {
  ...
  private boolean jj_3_7()
 {
  ...
  /** Constructor. */
  public JavaCCParser(String dsl) throws ParseException, TokenMgrError {
      this(new java.io.StringReader(dsl));
  }

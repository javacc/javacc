...
We've pretty much covered the various aspects of `LOOKAHEAD` in the previous sections. A couple of advanced topics follow. However, we shall now present a formal language reference for `LOOKAHEAD` in JavaCC:
